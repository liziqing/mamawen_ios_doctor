...
//    NSLog(@"%@",[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES)objectAtIndex:0]);
                                                                            /*
                                                                             /Users/lixuan/Library/Developer/CoreSimulator/Devices/7CEA5533-70C6-44BE-A239-FCB864BD74ED/data/Containers/Data/Application/3A8A2723-0662-4BE4-8D7B-3EBB950DE381/Documents
                                                                             */
    return [NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES)objectAtIndex:0];

//    NSArray *paths = NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES);   // 跑不到这里来，写着干嘛？
//    return [[paths objectAtIndex:0]stringByAppendingPathComponent:@"Voice"];
                                                                            /*
                                                                              /Users/lixuan/Library/Developer/CoreSimulator/Devices/7CEA5533-70C6-44BE-A239-FCB864BD74ED/data/Containers/Data/Application/57229AC4-6843-4D8C-87AF-575AC388A77D/Library/Caches
                                                                              */
}
